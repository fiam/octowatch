...
If Octowatch starts while your Mac is offline, the main window and menu bar now show a dedicated offline state with a manual retry button instead of a duplicate GitHub-connection prompt, and the app retries automatically when connectivity returns.
